...
| **渲染为图片** | 将已有几何项目导出为 PNG | [`POST /api/render/v2`](/api/render-v2) |
| **渲染为 SVG** | 将已有几何项目导出为矢量图 | [`POST /api/render-svg`](/api/render-svg) |
| **渲染为 TikZ** | 将已有几何项目导出为 LaTeX 源文件 | [`POST /api/render-tikz`](/api/render-tikz) |
