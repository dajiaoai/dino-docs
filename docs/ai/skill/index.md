...
Skill 是 MCP 的操作知识层，安装前请先完成 **MCP 授权**，并确认客户端能够调用大角几何 MCP 工具。
...
SkillHub 是专为中国用户优化的第三方 AI Skills 社区。大角几何 Skill 页面提供最新版本、内容说明、版本记录和下载入口：
...
- [在 MCP 中使用母版](../mcp/master-template)，统一 AI 绘图的背景、坐标轴和对象样式
