...
The Skill is an instruction layer for MCP, not a replacement for the MCP connection. Complete [MCP Integration](./mcp) first and confirm that your client can call the Dino-GSP MCP tools.
...
<a href="https://skillhub.cn/" target="_blank" rel="noreferrer">SkillHub</a> is a third-party AI Skills community optimized for users in China. Its interface and installation guide are primarily in Chinese. The Dino-GSP listing provides the latest release, description, version history, and download:
...
- [Use Master Templates with MCP](./master-template) to keep backgrounds, axes, and object styles consistent
